...
\end{tabularx}
\caption{Studentized residuals, Cook's values and leverage values. Studentized residuals are between -3 and +3 SDs. Cook's Distance values are $< 1$. Leverage values are $< .2$. There is no indication of highly influential points.}
