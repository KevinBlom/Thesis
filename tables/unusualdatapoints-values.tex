...
\end{tabularx}
\caption{Studentized residuals, Cook's values and leverage values. Studentized residuals should are between -3 and +3 SDs. Cook's Distance values should be < 1. Leverage values should be < .2.}
