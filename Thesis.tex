...
\label{sec:methods}
In order to test for correlation between touchscreen taps and emotion, a device specific application was written for gathering pressure data when an emotional response was elicited using \textbf{FOTOSET?} photo set.
