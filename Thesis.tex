...
% Lindstrom \cite{Lindstrom2011} used an MRI machine to show that the parts of the brain that are active when in love are the same parts that are active when someone hears their smartphone ring. He believes that users literally \textit{love} their smartphone.
