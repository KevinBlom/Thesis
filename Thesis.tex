...
The measuring of emotion is a broad field. In general it can be classified into three domains:
\begin{enumerate*}[label=(\alph*)]
  \item physiological detection,
  \item facial detection, and
  \item posture/gesture detection.
\end{enumerate*}
